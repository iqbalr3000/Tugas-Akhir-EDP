                            ...
                            <table id="example" class="table table-hover e-commerce-table second" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['role']; ?></td>
                                            <td class="text-right">
                                                <button class="btn btn-icon btn-hover btn-sm btn-rounded" data-toggle="modal" data-target="#modalEditUser<?= $row['id']; ?>">
                                                    <i class="anticon anticon-edit"></i>
                                                </button>
                                                <a href="action/hapusUser.php?id=<?= $row['id'];?>" class="btn btn-icon btn-hover btn-sm btn-rounded" onclick="return confirm('Yakin akan menghapus User ini?');">
                                ...
                                <?php
                                include 'modal/modalTambahUser.php';
