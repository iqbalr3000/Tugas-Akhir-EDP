...
<head>
    ...
    <title>Data Log Transaksi Pembelian Saldo</title>
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Log Transaksi Saldo</h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                <a href="index.php" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                                <span class="breadcrumb-item active">Log Transaksi Saldo</span>
                            </nav>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="example" class="table table-hover e-commerce-table second" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                            require "../koneksi.php"; 
                                            $datatampil = mysqli_query($koneksi, "SELECT * from tb_log_saldo INNER JOIN tb_rfid ON tb_rfid.rfid = tb_log_saldo.rfid ORDER BY tb_log_saldo.id DESC");
                                            $no=1;
