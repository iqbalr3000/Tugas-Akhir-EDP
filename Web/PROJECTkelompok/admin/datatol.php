                        ...
                        <div class="card-body">
                            <div class="row m-b-30">
                                ...
                                <div class="col-lg-4 text-right">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#modalTambahTol">
                            ...
                            <table id="example" class="table table-hover e-commerce-table second" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['harga']; ?></td>
                                            <td class="text-right">
                                                <button class="btn btn-icon btn-hover btn-sm btn-rounded" data-toggle="modal" data-target="#modalEditTol<?= $row['id']; ?>">
                                                    <i class="anticon anticon-edit"></i>
                                                </button>
                                                <a href="action/hapusTol.php?id=<?= $row['id'];?>" class="btn btn-icon btn-hover btn-sm btn-rounded" onclick="return confirm('Yakin akan menghapus Tol ini?');">
                                ...
                                <?php
                                include 'modal/modalTambahTol.php';
                                include 'modal/modalEditTol.php';
                                ?>
                            </div>
                        </div>
                    </div>
