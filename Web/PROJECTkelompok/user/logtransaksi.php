...
<head>
    ...
    <title>Data Log Pembelian Saldo</title>
                            ...
                            <table id="example" class="table table-hover e-commerce-table second" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $datatampil = mysqli_query($koneksi, "SELECT * from tb_log WHERE rfid = '$id'  ORDER BY tb_log.id DESC");
                                            $no=1;
