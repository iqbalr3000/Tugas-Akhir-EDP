...
<head>
    ...
    <title>Web Tol | Topup Saldo</title>
                ...
                <div class="side-nav-inner">
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle" href="topup.php">
                                <span class="icon-holder">
                                  <i class="anticon anticon-dollar"></i>
                                </span>
                                <span class="title">Topup Saldo</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle" href="logtransaksi.php">
                                <span class="icon-holder">
                                  <i class="anticon anticon-dollar"></i>
                                </span>
                                <span class="title">Log Transaksi</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle" href="gantiPassword.php">
                                <span class="icon-holder">
                        ...
                        <div class="card-body">
                            <form action="action/tambahSaldo.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="rfid" value="<?= $_SESSION['id']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="m-l-15">
                                                            <h2 class="m-b-0">Mobile Banking</h2>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
