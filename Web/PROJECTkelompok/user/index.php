            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    ...
                    <?php
                        require "../koneksi.php"; 
                        $id = $_SESSION['id'];
                        $datatampil = mysqli_query($koneksi, "SELECT * from tb_rfid WHERE rfid = '$id' ");
                        $no=1;
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0"><?= $row['nama']; ?></h2>
                                            <p class="m-b-0 text-muted">Nama</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0"><?= $row['alamat']; ?></h2>
                                            <p class="m-b-0 text-muted">Alamat</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0"><?= $row['no_telp']; ?></h2>
                                            <p class="m-b-0 text-muted">Nomot Telepon</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
